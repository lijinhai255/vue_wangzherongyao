      ...
      <el-tabs value="basic" type="border-card" class="right-main">
          ...
          <el-tabs value="basic">
            ...
            <el-tab-pane label="视频介绍" name="videos">
              <el-button
                ...
                type="primary"
                size="small"
                @click="model.introductions.push({})"
              >
                <i class="el-icon-plus"></i>添加英雄介绍视频
              </el-button>
                ...
                <el-col v-for="(item,i) in model.introductions" :key="i">
                  ...
                  <el-form-item label="视频  ">
                    <el-upload
                      ...
                      :on-success="res => item.video = res.url"
                      drag
                      multiple
                    >
                  ...
                  <el-form-item>
                    <el-button
                      size="small"
                      type="danger"
                      @click="model.introductions.splice(i,1)"
                    >删除</el-button>
                  </el-form-item>
                </el-col>
              </el-row>
          ...
          <el-tabs value="basic">
            ...
            <el-tab-pane label="克制谁" name="restraints">
              <el-button
                ...
                type="primary"
                size="small"
                @click="model.restraints.push({})"
              >
                <i class="el-icon-plus"></i>克制谁
              </el-button>
              <el-row type="flex" style="flex-wrap:wrap;">
        ...
        <el-tab-pane label="英雄攻略" name="raiders">
          <el-button
            ...
            type="primary"
            size="small"
            @click="model.heroGuides.push({})"
          >
            <i class="el-icon-plus"></i>添加英雄攻略
          </el-button>
          <el-row type="flex" style="flex-wrap:wrap;">
